# Especificación Funcional: Periodontograma Clínico (Documentación Viva)

Este documento detalla los requerimientos y escenarios de aceptación clínicos del Periodontograma Digital de la aplicación.
